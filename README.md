...
7+ years in Amazon advertising. Currently an Amazon PPC Specialist at **Emplicit**, where I designed and maintain the agentic tooling suite our team runs its weekly optimization cycle on.

I manage a five-brand portfolio, roughly $300K a month in ad spend against ~$1.4M a month in Amazon revenue, across supplements, kitchenware, personal care and golf retail.
...
**A 20-skill agentic PPC system** · 35 Python scripts, ~13,200 lines

Runs the weekly optimization cycle end to end across a ~$3.6M/yr ad portfolio:

1. **Ingest and reconcile.** Bulk exports joined across 7/30/60-day windows and stacked weeklies, so no decision rests on one noisy week. Entity IDs reconciled so a keyword is tracked continuously across exports.
...
**A quantitative decision framework** · adopted as my agency's optimization standard
